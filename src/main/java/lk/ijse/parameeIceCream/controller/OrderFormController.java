...
import lk.ijse.parameeIceCream.entity.tm.OrderTm;
...
public class OrderFormController {
    ...
    private void getCurrentOrderId() {
        try {
            ...
            String nextOrderId = placeOrderBO.generateNewOrderID();
    ...
    public void btnPlaceOrderOnAction(ActionEvent actionEvent) {
        ...
        var order = new OrderDTO(orderId, date, unitPrice, customerId);
        ...
        try {
            boolean isPlaced = placeOrderBO.placeOrder(order,odList);//PlaceOrderRepo.placeOrder(po);
            if(isPlaced) {
    ...
    private String getLastOrderId(){
        String orderId;
        try {
            orderId = placeOrderBO.getLastOId();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        } catch (ClassNotFoundException e) {
            throw new RuntimeException(e);
    ...
    private void getProductName() {
        ...
        try {
            List<String> nameList = placeOrderBO.getProductName();
    ...
    private void getCustomerTels() {
        ...
        try {
            List<String> telList = placeOrderBO.getCustomerTels();
    ...
    public void txtProductNameOnAction(ActionEvent actionEvent) {
        String name = txtProductName.getText();
        try {
            ProductDTO product = placeOrderBO.searchByProductName(name);
    ...
    public void txtCustomerTelOnAction(ActionEvent actionEvent) {
        ...
        try {
            CustomerDTO customer = placeOrderBO.searchCustomerTel(tel);
