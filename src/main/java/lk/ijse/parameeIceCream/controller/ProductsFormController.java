...
import lk.ijse.parameeIceCream.entity.tm.ProductTm;
...
public class ProductsFormController {
    ...
    private void getProductName() {
        ...
        try {
            List<String> nameList = ingredientsBO.getProductName();
    ...
    private void loadAllProduct() {
        ...
        try {
            List<ProductDTO> productList = ingredientsBO.getAllProduct();
    ...
    private void getDepartmentId() {
        ...
        try {
            List<String> idList = ingredientsBO.getDepartmentIds();
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        if (isValid()) {
            ProductDTO product = new ProductDTO(id, name, category, description, qtyAvailable, unitPrice, departmentId, path);

            boolean isUpdated = ingredientsBO.updateProduct(product);
            if (isUpdated) {
    ...
    public void cmbDepartmentIdOnAction(ActionEvent actionEvent) {
        ...
        try {
            DepartmentDTO department = ingredientsBO.searchDepartmentById(id);
    ...
    public void txtSearchHereOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        ProductDTO product = ingredientsBO.searchProductByName(name);
    ...
    private String getCurrentId() {
        ...
        try {
            ...
            nextId = ingredientsBO.generateProductNewID();
